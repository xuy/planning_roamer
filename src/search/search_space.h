...
class SearchSpace {
    ...
    vector<SearchSpaceNodeCallback*> get_node_callbacks;

    // A list of callback functions that will be invoked whenever a NEW node
    // is generated by using get_node.
    vector<SearchSpaceNodeCallback*> new_node_callbacks;
...
public:
    ...
    void process_nodes(const SearchSpaceNodeCallback* callback);
    void add_node_callback(SearchSpaceNodeCallback* callback);
    void add_new_node_callback(SearchSpaceNodeCallback* callback);
};
