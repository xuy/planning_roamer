...
class SearchSpace {
    ...
    vector<NodeCallback*> get_node_callbacks;

    // A list of callback functions that will be invoked whenever a NEW node
    // is generated by using get_node.
    vector<NodeCallback*> new_node_callbacks;
...
public:
    ...
    void add_node_callback(NodeCallback* callback);
    void add_new_node_callback(NodeCallback* callback);
};
